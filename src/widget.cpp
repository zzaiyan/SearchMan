...
const char *const DICT = "../dict/jieba.dict.utf8";
const char *const HMM = "../dict/hmm_model.utf8";
const char *const USER_DICT = "../dict/user.dict.utf8";
const char *const IDF = "../dict/idf.utf8";
const char *const STOP_WORD = "../dict/stop_words.utf8";

Widget::Widget(QWidget *parent)
    : QWidget(parent), ui(new Ui::Widget),
      jieba(DICT, HMM, USER_DICT, IDF, STOP_WORD) {
  ui->setupUi(this);
  ...
  connect(ui->lineEditNumber, SIGNAL(returnPressed()), ui->pushButtonGet,
          SIGNAL(clicked()), Qt::UniqueConnection);
  connect(ui->lineEditSource, SIGNAL(returnPressed()), ui->pushButtonGet,
          SIGNAL(clicked()), Qt::UniqueConnection);
...
void Widget::on_pushButtonLoad_clicked() {
  ...
  pagerank(pageNumber);
  QMessageBox::information(this, tr("载入链接"),
                           tr("载入链接完成，共载入%1个链接").arg(pageNumber));
